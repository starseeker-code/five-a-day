...
class PaymentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Additional Information", {"fields": ("observations", "document_url"), "classes": ("collapse",)}),
        (
            "System Information",
    ...
    def mark_as_completed(self, request, queryset):
        updated = queryset.update(payment_status="completed", payment_date=date.today())
...
class EnrollmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Pricing", {"fields": ("enrollment_amount", "discount_percentage", "final_amount")}),
        ("Additional Information", {"fields": ("document_url", "notes"), "classes": ("collapse",)}),
        (
            "System Information",
            {"fields": ("is_paid", "remaining_amount", "created_at", "updated_at"), "classes": ("collapse",)},
        ),
    )
